...
export default function EyewearPage() {
  ...
  async function fetchProducts() {
    try {
      ...
      // Filter products to only show eyewear
      const eyewearProducts = data.filter((product: Product) => 
        (product.category || '').toLowerCase() === 'eyewear' || 
        (product.subcategory || '').toLowerCase() === 'eyewear' ||
      ...
      <div className="relative overflow-hidden bg-white">
        ...
        <div className="relative mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
          ...
          >
            ...
            >
              Zbuloni koleksionin ekskluziv të syzeve. 
