...
const WhatsAppButton: React.FC = () => {
  ...
  return (
    <>
      {show && (
        <div className="fixed bottom-6 right-2 lg:right-6 z-40">
          {hover && (
            <div className="absolute bottom-full right-0 mb-3 w-64">
              <div className="bg-gray-900 text-white text-xs rounded-lg py-2 px-3 shadow-xl">
                <div className="text-center leading-relaxed">
                  <div className="font-medium mb-1">Përshëndetje!</div>
                  <div>Nëse ju nevojitet ndonjë informatë shtesë apo pyetje, na kontaktoni direkt duke klikuar ikonën në Whatsapp</div>
                </div>
